...
window.Shopify.formatMoney = function (
  cents,
  moneyFormat = window.Shopify.moneyFormat
) {
...
class SwiperSlider extends HTMLElement {
  ...
  breakpoints = {
    0: {
      slidesPerView:
        this.dataset.sliderPartialSlidesMobile === "true"
          ? Number(this.dataset.breakpointMobile) + 0.15
          : Number(this.dataset.breakpointMobile),
    },
  ...
  rows = {
    grid: {
      rows: this.dataset.sliderRows ? Number(this.dataset.sliderRows) : 1,
      fill: "row",
    },
  };
}
